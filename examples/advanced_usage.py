...
def compare_providers():
    ...
    translation_brief = DataHandler.load_translation_brief(
        os.path.join(os.path.dirname(__file__), '..', 'config', 'translation_brief_example.txt')
    )
    
    initial_message = "I need help understanding the technical documentation for your API."
